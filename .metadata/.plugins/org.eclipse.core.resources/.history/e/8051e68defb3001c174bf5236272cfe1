...
public class ShopTest {
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		//Check that there is a displayed message appears "Tokyo Talkies” has been added to your cart."
		...
		//FileInputStream fs = new FileInputStream("D:\\Selenuim\\Project\\SanityCheckP1\\ImportData.xlsx");
		FileInputStream fs = new FileInputStream("C:\\Users\\jihene.abidli\\Desktop\\Shop\\ImportData.xlsx");
			...
			String FirstName1 = sheet.getRow(0).getCell(0).getStringCellValue();
			...
			String LastName1 = sheet.getRow(0).getCell(1).getStringCellValue();
			...
			String Country1 = sheet.getRow(0).getCell(2).getStringCellValue();
			...
			String HouseNbr1 = sheet.getRow(0).getCell(3).getStringCellValue();
			...
			String Apartment1 = sheet.getRow(0).getCell(4).getStringCellValue();
			...
			String TownCity1 = sheet.getRow(0).getCell(5).getStringCellValue();
			...
			System.out.println(sheet.getRow(0).getCell(6).toString());
			String StateCountry1 = sheet.getRow(0).getCell(6).getStringCellValue();
			...
			System.out.println(sheet.getRow(0).getCell(7).toString());
			String PostCode1 = sheet.getRow(0).getCell(7).getStringCellValue();
			...
			System.out.println(sheet.getRow(0).getCell(8).toString());
			String Phone1 = sheet.getRow(0).getCell(8).getStringCellValue();
			...
			System.out.println(sheet.getRow(0).getCell(9).toString());
			String EmailAddr1 = sheet.getRow(0).getCell(9).getStringCellValue();
